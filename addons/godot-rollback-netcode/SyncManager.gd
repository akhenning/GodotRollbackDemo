...
var _debug_skip_nth_message_counter_2 := 0
...
func _reset() -> void:
	...
	_debug_skip_nth_message_counter_2 = 0
...
func _send_input_messages_to_all_peers() -> void:
	if debug_skip_nth_message > 1:
		...
		_debug_skip_nth_message_counter_2 += 1
		if _debug_skip_nth_message_counter_2 > 4:
			_debug_skip_nth_message_counter_2 = 0
		if _debug_skip_nth_message_counter >= debug_skip_nth_message or _debug_skip_nth_message_counter_2 != 0:
			#print("[%s] Skipping message to simulate packet loss" % _current_tick)
			# todo remove all references to _debug_skip_nth_message_counter_2
			_debug_skip_nth_message_counter = 0
			return
